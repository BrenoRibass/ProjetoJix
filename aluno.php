...
<body>
  <div id="app">
        ...
        <div class="level">
          <div class="level-left">
            <div class="level-item">
              <h1 class="title">
                Documentos - <?php echo $row_aluno['nome'] ?>
              </h1>
            </div>
          </div>
          ...
          <article class="media">
            ...
            <div class="content">
                <p>
                  ...
                  <br> 
                  <Strong>Horas de pesquisa: </strong> <?php echo $row_horas['total_pesquisa']; if(!empty($excedente_pesquisa)) echo " ($excedente_pesquisa hora(s) excedentes)";?>  
                  <Strong> | Horas de ensino: </strong> <?php echo $row_horas['total_ensino']; if(!empty($excedente_ensino)) echo " ($excedente_ensino hora(s) excedentes)";?>  
                  <Strong> | Horas de extensão: </strong> <?php echo $row_horas['total_extensao']; if(!empty($excedente_extensao)) echo " ($excedente_extensao hora(s) excedentes)";?>
                  <br>
                </p>
              </div>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      ?>
                        ...
                        <td data-label="Comany"><?php if ($row_table['homologado'] == '0') echo "Não homologado";else echo "<font color='green'> Homologado </font>"; //Status do documento ?></td>
                        <td data-label=""><?php echo date("d/m/Y", strtotime($row_table['data'])); //Data do envio do documento ?></td>
                        <td data-label=""><?php echo $row_table['pesquisa']; //Horas pesquisa ?></td>
                        <td data-label=""><?php echo $row_table['ensino']; //Horas ensino ?></td>
                        <td data-label=""><?php echo $row_table['extensao']; //Horas ext ?></td>
                      ...
                      <div class="modal-card">
                        ...
                        <section class="modal-card-body">
                          <form method="post" class="form_modal_j" enctype="multpart/form-data" id="<?php echo "form" . $row_table['id'] ?>">
                            ...
                            <input type='number' name='pesquisa' value="<?php echo $row_table['pesquisa'] ?>" min='0' class="input">

                            <p>Horas de Ensino </p>
                            <input type='number' name='ensino' value="<?php echo $row_table['ensino'] ?>" min='0' class="input">

                            <p>Horas de Extensão </p>
                            <input type='number' name='extensao' min='0' value="<?php echo $row_table['extensao'] ?>" class="input">

                            <input type='hidden' name='id' value="<?php echo $row_table['id'] ?>">
    ...
    <script>
      ...
      $(document).on('submit', '.form_modal_j', function() {
        var dados = new FormData(this);
        $.ajax({
          url: 'form_homologacao.php',
          type: 'POST',
          data: dados,
          dataType: 'json',
          processData: false,
